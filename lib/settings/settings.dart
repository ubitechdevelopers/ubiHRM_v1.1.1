...
import 'package:ubihrm/settings/department_list.dart';
import 'package:ubihrm/settings/designation_list.dart';
import 'package:ubihrm/settings/division_list.dart';
import 'package:ubihrm/settings/employee/employees_list.dart';
import 'package:ubihrm/settings/geofence_list.dart';
import 'package:ubihrm/settings/holiday/holiday_list.dart';
import 'package:ubihrm/home.dart';
import 'package:ubihrm/profile.dart';
import 'package:ubihrm/settings/regularization.dart';
import 'package:ubihrm/services/services.dart';
import 'package:ubihrm/settings/shift_list.dart';
                  ...
                  perAttendance=='1'?new RaisedButton(
                    ...
                    child: Container(
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                          Icon(Icons.calendar_today_outlined,size: 30.0,color: Colors.grey[400],),
                          SizedBox(width: 17.0),
                          Expanded(
                            child:Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                Container(
                                    child: Text('Regularization',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 20.0),)
                                ),
                              ],
                            ),
                          ),
