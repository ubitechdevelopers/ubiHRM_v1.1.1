...
class _EditEmployee extends State<EditEmployee> {
  ...
  FocusNode __dob = new FocusNode();
  FocusNode __doj = new FocusNode();
      ...
      if (mounted) {
        setState(() {
          ...
          if(datalist[0]["CountryCode"]!='') {
            ...
            for (int i = 0; i < _myJson.length; i++) {
              if (datalist[0]["CountryCode"] == _myJson[i]['countrycode']) {
  ...
  getempstsid() async{
    getEmpStatusList(0, 1).then((onValue) {
      for(int i = 0 ; i < onValue.length; i++){
        if(onValue[i]["Name"] == "On Job") {
          empsts = onValue[i]["Id"];
          finalempsts = onValue[i]["ActualValue"];
          print("getempstsid "+empsts+" "+finalempsts);
        }
      }
    });
  }
                    ...
                    children: <Widget>[
                      ...
                      globallabelinfomap['emp_code']!=''?Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (_empCode.text.trim().isEmpty || _empCode.text.isEmpty) {
                      ...
                      globallabelinfomap['first_name']!=''?Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (_firstName.text.trim().isEmpty || _firstName.text.isEmpty) {
                      ...
                      globallabelinfomap['last_name']!=''?Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (_lastName.text.trim().isEmpty || _lastName.text.isEmpty) {
                      ...
                      globallabelinfomap['dob']!=''?Padding(
                        ...
                        child: Container(
                          child:DateTimeField(
                            ...
                            validator: (value) {
                              if (_dob.text.isEmpty || _dob.text.trim().isEmpty) {
                      ...
                      globallabelinfomap['doj']!=''?Padding(
                        ...
                        child: Container(
                          child:DateTimeField(
                            ...
                            validator: (value) {
                              if (_doj.text.isEmpty || _doj.text.trim().isEmpty) {
      ...
      child: new AlertDialog(
        ...
        actions: <Widget>[
          RaisedButton(
            ...
            child: _isServiceCalling?Text("Adding..",
              style: TextStyle(color: Colors.white),
            ):Text("ADD",
              style: TextStyle(color: Colors.white),
            ),
  ...
  _showDialogLoc(BuildContext context) async {
    await showDialog<String>(
      barrierDismissible: false,
      context: context,
      child: new AlertDialog(
        ...
        actions: <Widget>[
          RaisedButton(
            ...
            child: _isServiceCalling? Text('Adding..', style: TextStyle(color: Colors.white),
  ...
  _showDialogGrade(BuildContext context) async {
    await showDialog<String>(
      barrierDismissible: false,
      context: context,
      child: new AlertDialog(
