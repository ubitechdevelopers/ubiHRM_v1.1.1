...
static SuperTooltip a;
  Offset _targetCenter;
  OverlayEntry _backGroundOverlay;
  OverlayEntry _ballonOverlay;
  static OverlayEntry myBackGroundOverlay;
  static OverlayEntry myBallonOverlay;
  static bool myIsOpen=false;
  SuperTooltip({
  ...
  static void myclose(){
    myBallonOverlay.remove();
    myBackGroundOverlay.remove();
    myIsOpen = false;
  }
