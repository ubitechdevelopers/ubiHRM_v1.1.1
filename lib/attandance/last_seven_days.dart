                                  ...
                                  if(snapshot.data.length>0) {
                                    ...
                                    return new Center(
                                      child: Container(
                                        ...
                                        color: appStartColor().withOpacity(0.1),
                                        padding:EdgeInsets.only(top:5.0,bottom: 5.0),
                                        child:Text("No absent employees found in last 7 days",style: TextStyle(fontSize: 14.0),textAlign: TextAlign.center,),
                                      ),
                                    );
                                  }
                                }
                                  ...
                                  if(snapshot.data.length>0) {
                                    ...
                                    return new Center(
                                      child: Container(
                                        ...
                                        color: appStartColor().withOpacity(0.1),
                                        padding:EdgeInsets.only(top:5.0,bottom: 5.0),
                                        child:Text("No late comer employees found in last 7 days",style: TextStyle(fontSize: 14.0),textAlign: TextAlign.center,),
                                      ),
                                    );
                                  }
                                }
                                  ...
                                  if(snapshot.data.length>0) {
                                    ...
                                    return new Center(
                                      child: Container(
                                        ...
                                        color: appStartColor().withOpacity(0.1),
                                        padding:EdgeInsets.only(top:5.0,bottom: 5.0),
                                        child:Text("No early leaver employees found in last 7 days",style: TextStyle(fontSize: 14.0),textAlign: TextAlign.center,),
                                      ),
                                    );
                                  }
                                }
