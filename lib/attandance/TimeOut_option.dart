...
class HomePageTimeOut extends StatefulWidget {
  @override
  _HomePageTimeOutState createState() => _HomePageTimeOutState();
}

class _HomePageTimeOutState extends State<HomePageTimeOut> {
...
*/
  ...
  saveImageTimeout() async {
    ...
    if (connectivityResult == ConnectivityResult.mobile || connectivityResult == ConnectivityResult.wifi) {
      ...
      try {
        issave = await saveImage.saveTimeOutOpt(mk,Attid);
        print('------------------>');
        print(issave);
        print('------------------>');
        if (issave) {
          ...
          new AlertDialog(
            content: new Text("Your overtime has been sent for approval"),
          )
          );
