...
class PayrollExpenseDetailView extends StatefulWidget {
  @override
  final String expenseid;
  PayrollExpenseDetailView({Key key,  this.expenseid}) : super(key: key);
  _PayrollExpenseDetailViewState createState() => _PayrollExpenseDetailViewState();
}

class _PayrollExpenseDetailViewState extends State<PayrollExpenseDetailView> {
        ...
        children: <Widget>[
          RaisedButton(
            ...
            onPressed: () {
              ...
              withdrawlPayrollExpense(widget.expenseid);
            },
          ),
          FlatButton(
                  ...
                  new Expanded(
                    child: Container(
                      ...
                      child: new FutureBuilder<List<PayrollExpense>>(
                        future: getPayrollExpenseDetailById(widget.expenseid),
