...
class ProfilePage_edit extends StatefulWidget {
  @override
  _ProfilePageState_edit createState() => _ProfilePageState_edit();
}

class _ProfilePageState_edit extends State<ProfilePage_edit> {
            ...
            children: <Widget>[
              ...
              FlatButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ProfilePage_edit()),
                  );
                },
              ),
