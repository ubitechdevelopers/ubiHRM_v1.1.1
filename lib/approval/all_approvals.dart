...
import 'package:ubihrm/approval/salary_expense_appproval.dart';
import 'package:ubihrm/approval/payroll_expense_approval.dart';
        ...
        Container(
            ...
            child:ListView(
                children: <Widget>[
                  ...
                  perEmployeeLeave == '1'?new RaisedButton(
                    padding: EdgeInsets.fromLTRB(10.0, 10.0, 10.0, 10.0),
                    child: Container(
                      child: Row(
