...
import 'package:ubihrm/approval/all_approvals.dart';
...
class PayrollExpenseApproval extends StatefulWidget {
  @override
  _PayrollExpenseApproval createState() => _PayrollExpenseApproval();
}

class _PayrollExpenseApproval extends State<PayrollExpenseApproval> {
  int idL;
  int _currentIndex = 0;
  var profileimage;
